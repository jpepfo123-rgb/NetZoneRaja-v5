    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={[styles.section, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <InputField label="Full Name *" value={name} onChangeText={setName} placeholder="Enter customer name" icon="user" colors={colors} />
          <InputField label="Mobile Number *" value={mobile} onChangeText={setMobile} placeholder="Enter mobile number" icon="phone" keyboardType="phone-pad" colors={colors} />
          <InputField label="Email" value={email} onChangeText={setEmail} placeholder="Enter email address" icon="mail" keyboardType="email-address" colors={colors} />
          <InputField label="Address" value={address} onChangeText={setAddress} placeholder="Enter address" icon="map-pin" colors={colors} />
        </View>
...
function InputField({
  label, value, onChangeText, placeholder, icon, keyboardType, colors,
}: {
